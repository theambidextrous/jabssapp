            ...
            <View style={[styles.stickyView, styles.stickyViewBottom, {flex:9}]}>
              <ScrollView>
                <View style={[styles.faqContainer, {flexDirection:"row"}]}>
                  ...
                  <View style={{flex:1}}>
                    <Icon onPress={()=> navigation.navigate('PersonalIn')} name="ios-arrow-dropright-circle" size={30} color={colors.secondary}></Icon>
                  </View>
                </View>
                <View style={[styles.faqContainer, {flexDirection:"row"}]}>
                  <View style={{flex:5}}>
                  ...
                  <View style={{flex:1}}>
                    <Icon name="ios-arrow-dropright-circle" size={30} color={colors.secondary} onPress={() => navigation.navigate('Security')}></Icon>
                  </View>
                </View>
                <View style={[styles.faqContainer, {flexDirection:"row"}]}>
                  <View style={{flex:5}}>
                    <Text style={styles.accountItemTitle}>
                      Manage credit cards</Text>
                  </View>
                  <View style={{flex:1}}>
                    <Icon name="ios-arrow-dropright-circle" size={30} color={colors.secondary} onPress={() => {
                      navigation.navigate('Card')}}></Icon>
                  </View>
                </View>
                <View style={[styles.faqContainer, {flexDirection:"row"}]}>
                  <View style={{flex:5}}>
                  ...
                  <View style={{flex:1}}>
                    <Icon name="ios-arrow-dropright-circle" size={30} color={colors.secondary} onPress={() => {
                      navigation.navigate('Notification')}}></Icon>
                  </View>
                </View>
              </ScrollView>
            </View>
